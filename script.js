...
//   leasePeriodInput.value = leasePeriod.value;
// }
// function syncLeasePeriodinput() {
//   const leasePeriodSelect = document.getElementById("leasePeriod");
//   const leasePeriodInput = document.getElementById("leasePeriodInput");
//   if (leasePeriodInput.value > 12 && leasePeriodInput.value < 60) {
//     leasePeriodSelect.value = leasePeriodInput.value;
//   }
// }
